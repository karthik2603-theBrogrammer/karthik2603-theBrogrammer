...
| Date                | News                                                                         |
|---------------------|----------------------------------------------------------------------------  |
| 24th October 2024 | I built a custom rule engine that parses language into an AST (Abstract Syntax Tree) and a DAG. Check it out [here](https://github.com/karthik2603-theBrogrammer/Karthik-Namboori-Zeotap-SDE-Intern/tree/main/Rule-Engine)! Drop your feedback through a star or an issue!|
